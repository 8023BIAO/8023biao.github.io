...
function Automatic_encryption()
  ...
  if list and list[1] then
    ...
    if loadfile(path) then
      ...
      local Junk_code=""
      for i=1,100 do
        Junk_code=Junk_code.."if nil then \n goto biao; goto biao; goto biao; goto biao; goto biao;goto biao;goto biao; ::biao:: \n end\n "
      end
      code=code.."\n"..Junk_code
...
--[[
我这个脑残智障的萌新学习用，轻喷，请指教，谢谢。
大佬可绕道与无视，代码均来至网络(已注明)
